...
// POST /internal/nodes/:id/archive
nodeRouter.post('/:id/archive', (req: Request, res: Response) => {
...
// POST /internal/nodes/:id/unarchive
nodeRouter.post('/:id/unarchive', (req: Request, res: Response) => {
